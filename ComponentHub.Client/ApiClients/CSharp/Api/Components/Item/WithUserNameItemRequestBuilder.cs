...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<WithUserNameItemRequestBuilderGetQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<WithUserNameItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
#endif
        ...
        public class WithUserNameItemRequestBuilderGetQueryParameters {
            [QueryParameter("page")]
        ...
        public class WithUserNameItemRequestBuilderGetRequestConfiguration : RequestConfiguration<WithUserNameItemRequestBuilderGetQueryParameters> {
        }
    }
}
